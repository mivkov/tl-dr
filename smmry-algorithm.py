...
""" Given an input text, returns a list of up to 20 of the longest and/or most obscurely-worded 
...
def summarize(input_text):
    ...
    maxIndices = sorted(range(len(sentenceValues)), key=lambda i: sentenceValues[i])[-min(int(len(sentences)/20 + 1), 20):]
